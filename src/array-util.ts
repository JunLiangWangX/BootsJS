/*
 * @Description: Some utils for working with array.(一些处理数组的工具)
 * @Author: JunLiangWang
 * @Date: 2024-03-28 11:01:41
 * @LastEditors: JunLiangWang
 * @LastEditTime: 2024-07-31 15:34:37
 */
 ...
 * arr2=[1,2,3,1,4];
 * ArrayUtil.removeDuplicates(arr1) // [{a:'1'},{a:'1'}]
 * ArrayUtil.removeDuplicates(arr1,true) // [{a:'1'}]
 * ArrayUtil.removeDuplicates(arr2) //[1,2,3,4];
 */
