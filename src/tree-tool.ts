...
export class TreeTool {
     ...
     *      ]
     */
    static tree2Array(treeList: Array<any>, childListAttributeName: string, options: Tree2ArrayOptions = tree2ArrayDefaultOptions): Array<any> {
     ...
     *      ]
     */
    static filter(treeList: Array<any>, childListAttributeName: string, filterFunction: (value: any, index: number, array: any[]) => boolean, options: Tree2ArrayOptions = tree2ArrayDefaultOptions) {
        return this.tree2Array(treeList, childListAttributeName, options).filter(filterFunction)
    }
    /**
